        ...
        <section className="py-12 md:py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mt-12 text-center  flex justify-center">
              <div>
              <Link href='/pages/products-page' className='block px-3 py-2 rounded-md text-base font-medium bg-blue-600 text-white hover:text-white hover:bg-blue-300 transition-colors duration-200'>View all Product</Link>
              </div>
            </div>
          </div>
        </section>
